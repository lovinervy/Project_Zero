...
class DB:
    ...
    def insert_youtube(self, url: str) -> int:
    ...
    def update_youtube(self, youtube_id: int, url: str) -> None:
        sql = ''' UPDATE youtube set url = ? WHERE id = ?; '''
        self.cursor.execute(sql, (url, youtube_id))
        self.connect.commit()

    def delete_youtube(self, youtube_id: int) -> None:
        sql = ''' DELETE FROM youtube WHERE id = ? ;'''
        self.cursor.execute(sql, (youtube_id,))
        self.connect.commit()

    def insert_translates(self, youtube_id: int, language: str) -> int:
    ...
    def update_translates(self, translates_id: int, language: str) -> None:
        sql = ''' UPDATE translates SET language = ? WHERE id = ?; '''
        self.cursor.execute(sql, (language, translates_id))
        self.connect.commit()

    def delete_translates(self, translates_id: int) -> None:
        sql = ''' DELETE FROM translates WHERE id = ?; '''
        self.cursor.execute(sql, (translates_id,))
        self.connect.commit()

    def insert_subtitles(self, translates_id: int, name: str) -> int:
    ...
    def update_subtitles(self, subtitles_id: int, name: str) -> None:
        sql = ''' UPDATE subtitles SET name = ? WHERE id = ?;'''
        self.cursor.execute(sql, (name, subtitles_id))
        self.connect.commit()

    def delete_subtitles(self, subtitles_id: int) -> None:
        sql = ''' DELETE FROM subtitles WHERE id = ?; '''
        self.cursor.execute(sql, (subtitles_id,))
        self.connect.commit()

    def insert_voiceovers(self, translates_id: int, name: str) -> int:
    ...
    def update_voiceovers(self, voiceovers_id: int, name: str) -> None:
        sql = ''' UPDATE voiceovers SET name = ? WHERE id = ?;'''
        self.cursor.execute(sql, (name, voiceovers_id))
        self.connect.commit()

    def delete_voiceovers(self, voiceovers_id: int) -> None:
        sql = ''' DELETE FROM voiceovers WHERE id = ?; '''
        self.cursor.execute(sql, (voiceovers_id,))
        self.connect.commit()

    def insert_video(self, youtube_id: int, name: str) -> int:
    ...
    def update_video(self, video_id: int, name: str) -> None:
        sql = ''' UPDATE  video SET name = ? WHERE id = ?; '''
